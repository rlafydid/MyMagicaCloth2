                ...
                for (int k = 0; k < Define.System.AngleLimitIteration; k++)
                {
                    ...
                    for (int i = 0; i < dcnt; i++, dataIndex++)
                    {
                        ...
                        if (useAngleRestoration)
                        {
                            ...
                            // Debug.Log($"before i:{i} stiffness:{restorationStiffness} cdepth:{cdepth} w:{simulationPower.w}");
                            ...
                            // Debug.Log($"after i:{i} stiffness:{restorationStiffness} cdepth:{cdepth} gravityFalloff:{gravityFalloff} restorationRotRatio:{restorationRotRatio} restorationAttn:{restorationAttn}");
