...
namespace MagicaCloth2
{
    ...
    public partial class ClothSerializeData
    {
        ...
        /// <summary>
        /// 初期姿勢での重力の減衰率(0.0 ~ 1.0) 初始姿势下的重力衰减率（0.0~1.0）
        /// 1.0にすることで初期姿勢では重力係数が０になる。 1.0，在初始姿势下重力系数为0。
        /// 0.0では常にどの姿勢でも重力が100%発生する。 0.0时，无论哪个姿势都会100%产生重力。
        /// 
        ...
        /// <summary>
        /// リセット後の速度安定化時間(s) 复位后的速度稳定时间（s）
        /// 急激な速度変化を抑えます。 控制急剧的速度变化。
        /// 
        ...
        /// <summary>
        /// 元の姿勢とシミュレーション結果のブレンド割合(0.0 ~ 1.0) 原始姿势与模拟结果的混合比例（0.0~1.0）
        /// 
