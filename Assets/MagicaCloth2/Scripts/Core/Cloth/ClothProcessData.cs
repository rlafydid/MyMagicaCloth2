...
{
    /// <summary>
    /// MagicaClothコンポーネント処理のデータ部分 组件处理的数据部分
    /// </summary>
    public partial class ClothProcess : IDisposable, IValid, ITransform
    {
        ...
        /// <summary>
        /// BoneClothのセットアップデータ BoneCloth设置数据
        /// </summary>
        ...
        /// <summary>
        /// コライダーリスト 协作者列表
        /// コライダーが格納されるインデックスは他のデータのインデックスと一致している 包含协作器的索引与其他数据的索引匹配
        /// </summary>
