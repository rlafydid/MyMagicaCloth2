...
namespace MagicaCloth2
{
    public static class MathUtility
    {
        ...
        /// 计算并返回三角形的切线。
        /// 切线被单位化。但是，根据状况有长度为0的情况，此时返回矢量0。
        /// </summary>
        /// <param name="p0"></param>
        /// <param name="p1"></param>
        /// <param name="p2"></param>
        ...
        /// <param name="shiftVector">シフト移動量 位移移动量</param>
        /// <param name="shiftRotation">シフト回転量 位移旋转量</param>
        /// <returns></returns>
